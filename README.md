...
│   │   ├── html/                    # Raw HTML files
│   │   │   ├── .gitkeep             # Placeholder to keep the html/ directory
│   │   ├── pdf/                     # Unprocessed PDF files
│   │   │   ├── .gitkeep             # Placeholder to keep the pdfs/ directory
│   │   ├── json/                    # Raw JSON files
│   │   │   ├── .gitkeep             # Placeholder to keep the json/ directory
│   │   ├── csv/                     # Raw CSV files
│   │   │   ├── .gitkeep             # Placeholder to keep the csv/ directory
│   │   ├── other/                   # Miscellaneous file formats
│   │   │   ├── .gitkeep             # Placeholder to keep the other/ directory
...
The toolkit includes the following standardised directories for managing data:

- **`data/raw/`**: Stores unprocessed input data, organised by file type:
  - **`html/`**: Raw HTML files.
  - **`pdfs/`**: Unprocessed PDF files.
  - **`json/`**: Raw JSON files.
  - **`csv/`**: Raw CSV files.
  - **`other/`**: Miscellaneous formats.

- **`data/cleaned/`**: Holds cleaned data after preprocessing (e.g., normalised, deduplicated text).
- **`data/processed/`**: Contains fully processed data, ready for training or analysis.
- **`data/generated/`**: Stores any output generated by scripts or pipelines.
